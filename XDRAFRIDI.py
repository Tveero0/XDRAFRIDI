...
def buy():
	try:
		...
		try:
			...
			print(50*"-")
			print(f"{g} Key : {VEERO}{s}")
			print(50*"-")
			print(r"       Name Tho Suna Hoga Veero Dada Of All Fb ")
			print(50*"-")
			print(f" 15-Days Price : 350")
			print(f" 1-Month Price : 500")
			print(50*"-")
			input("[Press Enter To Send Key Veero Admin]")
			os.system(f"termux-open-url https://wa.me/+923424080882?text={VEERO}")
			buy()
...
def main():
	...
	if menu_opt =='1':
		...
		xchker()
		os.system('xdg-open https://https://raw.githubusercontent.com/Tveero0/oproval.txt/main/oproval.txt')
		main()
	elif menu_opt =='4':
